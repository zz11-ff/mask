...
def single2tensor(img):
    """
    Always convert input image to (1, H, W) grayscale tensor.
...
def split_imageset(original_dataroot, taget_dataroot, n_channels=1, p_size=512, p_overlap=96, p_max=800):
    """
